...
use crate::IntoColorError::IntConversion;
...
fn parse_u8_from_i16(num: i16) -> Result<u8, IntoColorError> {
    if num > 256 || num < 0 {
...
impl TryFrom<(i16, i16, i16)> for Color {
    ...
    fn try_from(tuple: (i16, i16, i16)) -> Result<Self, Self::Error> {
        Ok(Self {
            red: parse_u8_from_i16(tuple.0)?,
            green: parse_u8_from_i16(tuple.1)?,
            blue: parse_u8_from_i16(tuple.2)?,
        })
    }
}
...
impl TryFrom<[i16; 3]> for Color {
    ...
    fn try_from(arr: [i16; 3]) -> Result<Self, Self::Error> {
        Ok(Self {
            red: parse_u8_from_i16(arr[0])?,
            green: parse_u8_from_i16(arr[1])?,
            blue: parse_u8_from_i16(arr[2])?,
        })
    }
}
...
impl TryFrom<&[i16]> for Color {
    ...
    fn try_from(slice: &[i16]) -> Result<Self, Self::Error> {
        ...
        Ok(Self {
            red: parse_u8_from_i16(slice[0])?,
            green: parse_u8_from_i16(slice[1])?,
            blue: parse_u8_from_i16(slice[2])?,
        })
    }
}
